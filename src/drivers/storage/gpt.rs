...
pub fn read_gpt_header() -> Option<GPTHeader> {
    ...
    Some(GPTHeader {
        ...
        current_lba: u64::from_le_bytes([
            lba[24], lba[25], lba[26], lba[27], lba[28], lba[29], lba[30], lba[31],
        ]),
        backup_lba: u64::from_le_bytes([
            lba[32], lba[33], lba[34], lba[35], lba[36], lba[37], lba[38], lba[39],
        ]),
        primary_part_tbl_lba: u64::from_le_bytes([
            lba[40], lba[41], lba[42], lba[43], lba[44], lba[45], lba[46], lba[47],
        ]),
        secondary_part_tbl_lba: u64::from_le_bytes([
            lba[48], lba[49], lba[50], lba[51], lba[52], lba[53], lba[54], lba[55],
        ]),
        disk_guid: u128::from_le_bytes([
            lba[56], lba[57], lba[58], lba[59], lba[60], lba[61], lba[62], lba[63], lba[64],
            lba[65], lba[66], lba[67], lba[68], lba[69], lba[70], lba[71],
        ]),
        part_entry_begin: u64::from_le_bytes([
            lba[72], lba[73], lba[74], lba[75], lba[76], lba[77], lba[78], lba[79],
        ]),
        ...
        for address in header.part_entry_begin..header.primary_part_tbl_lba {
            ...
            for partition in lba.chunks(header.part_size as usize) {
                ...
                table.partitions.push_back(GPTPartition {
                    partition_type_guid: u128::from_le_bytes([
                        partition[0],
                        partition[1],
                        partition[2],
                        partition[3],
                    ...
                    attrib_flags: u64::from_le_bytes([
                        partition[48],
                        partition[49],
                        partition[50],
                        partition[51],
