...
if devices[calculate_pos(device.bus as usize, device.slot as usize, device.func as usize)].is_none() {
devices[calculate_pos(device.bus as usize, device.slot as usize, device.func as usize)] = Some(device);
} else {
printkln!("Warning: PCI device conflict found");
printkln!("Warning: bus {:X}, slot {:X}, function {:X} already contains a device profile", device.bus, device.slot, device.func);
...
slot: slot as u32,
                    ...
                    latency_timer: read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(8..=15),
                    cache_line_size: read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(0..=7),
                    // Determine header type and set up appropriate structures from there
                    // Conditional initialization.
                    gen_dev_tbl: if read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(16..=23) == 0x00 {
                        Some(GeneralDeviceTable {
                            bars: [
                                ...
                                calculate_bar_addr(read_dword(bus as u8, slot as u8, function as u8, 0x24), 0),
                            ],
                            cis_ptr: read_dword(bus as u8, slot as u8, function as u8, 0x28).get_bits(24..=31),
                            subsystem_id: read_dword(bus as u8, slot as u8, function as u8, 0x2C).get_bits(24..=31),
                            subsystem_vendor_id: read_dword(bus as u8, slot as u8, function as u8, 0x2C)
                                .get_bits(16..=23),
                            expansion_rom_addr: read_dword(bus as u8, slot as u8, function as u8, 0x30)
                                .get_bits(24..=31),
                            caps_ptr: read_dword(bus as u8, slot as u8, function as u8, 0x34).get_bits(16..=23),
                            max_latency: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(24..=31),
                            min_grant: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(16..=23),
                            interrupt_pin: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(8..=15),
                            interrupt_line: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(0..=7),
                        })
                    } else {
                        None
                    },
                    pci_to_pci_bridge_tbl: if read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(16..=23)
                        == 0x01
                    {
                        Some(PCIToPCIBridgeTable {
                            bars: [
                                ...
                                calculate_bar_addr(read_dword(bus as u8, slot as u8, function as u8, 0x14), 0),
                            ],
                            sec_latency_timer: read_dword(bus as u8, slot as u8, function as u8, 0x18)
                                .get_bits(24..=31),
                            sub_bus: read_dword(bus as u8, slot as u8, function as u8, 0x18).get_bits(16..=23),
                            sec_bus: read_dword(bus as u8, slot as u8, function as u8, 0x18).get_bits(8..=15),
                            prim_bus: read_dword(bus as u8, slot as u8, function as u8, 0x18).get_bits(0..=7),
                            sec_status: read_dword(bus as u8, slot as u8, function as u8, 0x1C).get_bits(24..=31),
                            io_limit: read_dword(bus as u8, slot as u8, function as u8, 0x1C).get_bits(16..=23),
                            io_base: read_dword(bus as u8, slot as u8, function as u8, 0x1C).get_bits(8..=15),
                            mem_limit: read_dword(bus as u8, slot as u8, function as u8, 0x20).get_bits(24..=31),
                            mem_base: read_dword(bus as u8, slot as u8, function as u8, 0x20).get_bits(16..=23),
                            prefetch_mem_limit: read_dword(bus as u8, slot as u8, function as u8, 0x24)
                                .get_bits(24..=31),
                            prefetch_mem_base: read_dword(bus as u8, slot as u8, function as u8, 0x24)
                                .get_bits(16..=23),
                            prefetch_base_upper32: read_dword(bus as u8, slot as u8, function as u8, 0x28)
                                .get_bits(0..=31),
                            prefetch_limit_upper32: read_dword(bus as u8, slot as u8, function as u8, 0x2C)
                                .get_bits(0..=31),
                            io_limit_upper16: read_dword(bus as u8, slot as u8, function as u8, 0x30).get_bits(16..=31)
                                as u16,
                            io_base_upper16: read_dword(bus as u8, slot as u8, function as u8, 0x30).get_bits(0..=15)
                                as u16,
                            caps_ptr: read_dword(bus as u8, slot as u8, function as u8, 0x34).get_bits(16..=23),
                            expansion_rom_addr: read_dword(bus as u8, slot as u8, function as u8, 0x38)
                                .get_bits(24..=31),
                            bridge_control: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(24..=31),
                            interrupt_pin: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(16..=23),
                            interrupt_line: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(8..=15),
                        })
                    } else {
                        None
                    },
                    pci_to_card_bus_bridge_tbl: if read_dword(bus as u8, slot as u8, function as u8, 0x0C)
                        .get_bits(16..=23)
                        == 0x02
                    {
                        Some(PCIToCardBusBridgeTable {
                            exca_base_addr: read_dword(bus as u8, slot as u8, function as u8, 0x10).get_bits(24..=31),
                            sec_status: read_dword(bus as u8, slot as u8, function as u8, 0x14).get_bits(24..=31),
                            caps_lst_offset: read_dword(bus as u8, slot as u8, function as u8, 0x14).get_bits(8..=15),
                            card_bus_latency_timer: read_dword(bus as u8, slot as u8, function as u8, 0x18)
                                .get_bits(24..=31),
                            sub_bus: read_dword(bus as u8, slot as u8, function as u8, 0x18).get_bits(16..=23),
                            card_bus_bus: read_dword(bus as u8, slot as u8, function as u8, 0x18).get_bits(8..=15),
                            pci_bus: read_dword(bus as u8, slot as u8, function as u8, 0x18).get_bits(0..=7),
                            mem_base_addr0: read_dword(bus as u8, slot as u8, function as u8, 0x1C).get_bits(24..=31),
                            mem_limit0: read_dword(bus as u8, slot as u8, function as u8, 0x20).get_bits(24..=31),
                            mem_base_addr1: read_dword(bus as u8, slot as u8, function as u8, 0x24).get_bits(24..=31),
                            mem_limit1: read_dword(bus as u8, slot as u8, function as u8, 0x28).get_bits(24..=31),
                            io_base_addr0: read_dword(bus as u8, slot as u8, function as u8, 0x2C).get_bits(24..=31),
                            io_base_limit0: read_dword(bus as u8, slot as u8, function as u8, 0x30).get_bits(24..=31),
                            io_base_addr1: read_dword(bus as u8, slot as u8, function as u8, 0x34).get_bits(24..=31),
                            io_base_limit1: read_dword(bus as u8, slot as u8, function as u8, 0x38).get_bits(24..=31),
                            bridge_control: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(24..=31),
                            interrupt_pin: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(16..=23),
                            interrupt_line: read_dword(bus as u8, slot as u8, function as u8, 0x3C).get_bits(8..=15),
                            subsystem_vendor_id: read_dword(bus as u8, slot as u8, function as u8, 0x40)
                                .get_bits(24..=31),
                            subsystem_device_id: read_dword(bus as u8, slot as u8, function as u8, 0x40)
                                .get_bits(16..=23),
                            legacy_base_addr: read_dword(bus as u8, slot as u8, function as u8, 0x44)
                                .get_bits(24..=31),
                        })
                    } else {
                        None
                ...
                {
                let mut bist = read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(24..=31) as u8;
                ...
                while read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(24..=31).get_bit(6) {
...
if read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(24..=31).get_bits(0 ..= 3) > 0 {
printkln!("PCI: Bist failed on bus {:X}h, slot {:X}h, function {:X}h, device {:X}h, vendor {:X}h, class {:X}h, subclass {:X}h", bus as u8, slot as u8, function as u8, device, vendor, class, subclass);
continue;
}
pcidev.bist = read_dword(bus as u8, slot as u8, function as u8, 0x0C).get_bits(24..=31);
}
}
                add_device(pcidev);
            }
...
if dev.is_some() && dev.unwrap().class == class && dev.unwrap().subclass == subclass && dev.unwrap().prog_if == interface {
return *dev;
}
}
None
...
#[no_mangle]
pub extern "C" fn find_device_ex(class: u32, subclass: u32, vendors: &[u32], device_ids: &[u32]) -> Option<PCIDevice> {
let devices = PCI_DEVICES.lock();
for dev in devices.iter() {
